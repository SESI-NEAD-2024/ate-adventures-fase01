...
export default {
  ...
  methods: {
    ...
    saveLocalStorage() {
      ...
      //   (getScormData && FIELDS && getScormData(FIELDS.studentName)) ||
      //   this.playerDefault.Jogador_Nome;
      // this.scormData.student_id =
      //   (getScormData && FIELDS && getScormData(FIELDS.studentId)) ||
      //   this.playerDefault.Personagem;
      ...
      try {
        // Identificador de pessoa
        this.scormData.student_name = getScormData(FIELDS.studentName) || this.playerDefault.Jogador_Nome;
        this.scormData.student_id = getScormData(FIELDS.studentId) || this.playerDefault.Personagem;
    ...
    setupGame() {
      ...
      gameIframe.addEventListener("load", () => {
        // Deleta callback quando iframe carregar totalmente
